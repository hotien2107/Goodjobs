        ...
        <div>
          ...
          <div className="w-full">
            <div className="flex justify-around py-3 border-t-2 ">
              ...
              <div className="flex items-center text-2xl text-gray-600 hover:text-blue-500 cursor-pointer">
              ...
              <div className="flex items-center text-2xl text-gray-600 hover:text-purple-500 cursor-pointer">
                <svg width="1em" height="1em" viewBox="0 0 24 24">
                  <path
