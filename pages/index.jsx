        ...
        <div>
          ...
          <div className="w-full flex justify-center mb-6">
            <div className="w-4/5 content-center max-w-screen-xl">
              ...
              <div className="text-sm">Giúp các Ứng viên có nhiều vơ hội việc làm, kết nối Ứng viên với HR với nhau</div>
              ...
              <div className="my-12 grid grid-cols-3 gap-x-6">
                <div
                  onClick={() => router.push("/template-cv")}
                  className="flex items-center justify-center px-4 py-8 bg-purple-900 text-white rounded-lg cursor-pointer"
                >
