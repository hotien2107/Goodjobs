              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input
                      type="email"
                      className="w-full py-2 pl-3 pr-3 -ml-10 border-2 border-gray-200 rounded-lg outline-none focus:border-indigo-500"
